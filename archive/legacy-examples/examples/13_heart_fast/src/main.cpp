/*
 * ============================================================================
 * HEART SCULPTURE - FAST AUTO LOOP
 * ============================================================================
 *
 * BEHAVIOR:
 * 1. Wait 3 seconds on startup
 * 2. Automatically start looping
 * 3. Loop with 3 full rotations (1080°) at 50% faster speed
 * 4. Adjustable parameters via serial
 *
 * ============================================================================
 */
...
int32_t loopDistance = STEPS_PER_REVOLUTION * 3;  // Default: 1080° (3 full rotations - 50% more)
int32_t loopPauseTime = 0;  // Default: 0ms (no pause)
const int32_t FAST_SPEED = 1200;  // 50% faster than 800 (800 * 1.5 = 1200)
...
void gentleRotation(int32_t direction) {
  ...
  while (true) {
    ...
    // APPLY FAST SPEED (50% faster)
    motorSetSpeed(FAST_SPEED * direction);
    delay(10);
  }
...
void setup() {
  ...
  Serial.println("\n\n");
  Serial.println("============================================");
  Serial.println("  HEART SCULPTURE - FAST AUTO LOOP");
  Serial.println("============================================\n");
