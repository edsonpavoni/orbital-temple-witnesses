/*
 * ============================================================================
 * FIRST WITNESS — choreographed cycle firmware (16_witness_choreography)
 * ============================================================================
 *
 * Forked from 14_witness_provision on 2026-05-04. All boot/calibration/
 * network plumbing identical. Only the post-boot behavior changes:
 *
 ...
 *     6. 1080° position-mode spin → land precisely at visual zero.
 *
 *   Choreography loop (NEW — runs forever after boot):
 *     A. ENTER_SAT: 8 s eased cosine to live satellite az.
 *     B. HOLD_SAT:  freeze at that az for 10 s.
 *     C. RELEASE_1: motor OFF for 2 s — pointer drops under gravity.
 *     D. SPIN:      07-style speed-mode 1080° (random CW/CCW, gravity swing).
 *     E. RELEASE_2: motor OFF for 2 s — pointer drops again.
 *     F. Re-engage in position mode at current encoder. Loop to (A).
 *
 *   Total cycle ≈ 36 s.
 *
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================");
  Serial.println("  " SCULPTURE_NAME " — choreography mode");
  Serial.println("============================================");
  Serial.println("Boot: power gate -> wifi+ntp -> daily fetch -> homing");
  Serial.println("      -> 1080 spin -> CHOREO loop (find sat, hold 10s,");
  Serial.println("      release, spin random dir, release, repeat).");
